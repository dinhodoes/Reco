...
Using the Rekognize API, photos can be trained to recognize patterns in facial coordinates and topography making it easier to search against and find what you're looking. To use simply add gem 'rekognize' in your Gemfile and run a bundle install. 
